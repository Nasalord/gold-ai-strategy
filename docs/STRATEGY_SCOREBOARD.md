...
| **AI65** | XAUUSD ORB | Replication/parity unresolved | None | creator target about **+552.94%, PF 1.667, 670 trades** | Independent provider/execution work not yet sufficient for a frozen long-term judgment | n/a | n/a | n/a | Not eligible for health monitoring until parity/replication gate is resolved | **Next research priority; incomplete** |
...
AI1 is rejected and should not consume monitoring resources. AI65 does not get a monitor until its replication gate is resolved.
